    ...
    <AuthLayout>
      <section className="rounded-2xl border border-white/10 bg-slate-800/80 p-7 shadow-2xl backdrop-blur-sm sm:p-8">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white">Gabung dengan AtapBumi</h1>

          <p className="mt-2 text-sm text-zinc-400">Mulai berbagi cerita bersama komunitas pendaki.</p>
        </div>
